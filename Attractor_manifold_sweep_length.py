...
plt.figure()
# plt.plot(Animal_speed/Spacing*np.pi*2, Spacing/np.pi,'k--')
plt.plot(Animal_speed/Spacing*np.pi*2*1000, sweep_length,'k.')
plt.plot(Animal_speed/Spacing*np.pi*2*1000, sweep_length)
plt.ylim([0, 2.5])
plt.xlabel('Phase speed')
plt.ylabel('Sweep length')
filename = './figures/Phase_sweep_length.png'
